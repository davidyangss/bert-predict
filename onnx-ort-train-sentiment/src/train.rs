...
fn main() -> ort::Result<()> {
	...
	let trainer = Trainer::new(
		p,
		Allocator::default(),
		Checkpoint::load("/home/yangss/workspace/rust/ort.git/tools/train-data/mini-clm/checkpoint")?,
	...
	let tokenizer = Tokenizer::from_file(
		Path::new("/home/yangss/workspace/rust/ort.git/examples/gpt2/data/tokenizer.json"))
	.unwrap();
	...
	let mut dataset = File::open("/home/yangss/workspace/rust/ort.git/tools/train-data/mini-clm/dataset.bin").unwrap();

...
auto_tokenizer_model_name_or_path=os.environ.get("AUTO_TOKENIZER_MODEL_NAME_OR_PATH", output)
...
inputs = tokenizer("5月8日付款成功，当当网显示5月10日发货，可是至今还没看到货物，也没收到任何通知，简不知怎么说好！！！", return_tensors="pt")

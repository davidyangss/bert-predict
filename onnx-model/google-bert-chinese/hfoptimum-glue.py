...
def main():
    ...
    optimized_model_path = os.path.join(training_args.output_dir, "model.onnx")
    ...
    optimizer = ORTOptimizer.from_pretrained(model_or_path=model)
    ...
    logger.info(f"Model optimized and saved to {optimized_model_path}")
